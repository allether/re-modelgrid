...
QueryBuilderView = class QueryBuilderView extends Component {
  ...
  render() {
    var clone_query_btn, qi, query_editor, query_title_label, save_query_btn, select_query_key_btn;
    ...
    }, this.props.query_item.error || 'ok')))));
  }
...
QuerySaverView = class QuerySaverView extends Component {
  ...
  render() {
    var bookmark_description, bookmark_label_input, delete_bookmark_button, qi, save_query_btn;
    qi = this.props.query_item;
    ...
    }, bookmark_label_input, bookmark_description));
  }
...
SearchView = class SearchView extends Component {
  ...
  async onSearchEnter() {
    ...
    if (this.state.search_value[0] === '/' && this.state.search_v) {
      if (!this.props.selectFirstSearchQuery()) {
        return this.setState({
  ...
  render() {
    ...
    return h('div', {
      ...
      className: 'flex-right pad bot-left',
      style: {
        // bottom: '12px'
        paddingTop: 0
      }
...
TabsView = class TabsView extends Component {
  ...
  renderTab(qi) {
    var btn_style, color_dot, cstyle, f_i, i_color, part_spans;
    boundMethodCheck(this, TabsView);
  ...
  filterAndCombineQueries() {
    ...
    arr = arr.filter((qi, i) => {
      var ref;
      if (!this.state.search_label) {
        if (qi._id === ((ref = this.props.query_item) != null ? ref._id : void 0)) {
          return false;
        }
        return true;
    ...
    if (((ref = this.props.query_item) != null ? ref.updated_at : void 0) && !this.state.search_label) {
      ...
      arr.unshift(this.renderTab(this.props.query_item));
    }
    return arr;
  }
